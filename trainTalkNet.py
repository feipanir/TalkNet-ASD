Timport time, os, torch, argparse, warnings, glob
...
def main():
    ...
    parser.add_argument('--evalModelPath',   type=str, default=None, help = "the evaluation model")
    ...
    if args.evaluation == True:
        ...
        s = talkNet(**vars(args))
        eval_model_path = args.evalModelPath if args.evalModelPath else 'pretrain_AVA.model'
        s.loadParameters(eval_model_path)
